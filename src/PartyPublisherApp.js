...
class PartyPublisherApp extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = {parties: [], partyName: '', description:'', eventDate:moment(), eventHour:'09:30', address:'',place:'', price: 0, optionalDescription:'', typeOfMusic:'', assistants:[]};
        ...
        this.handleOptionalDescriptionChange=this.handleOptionalDescriptionChange.bind(this);
            ...
            <div className="App">
                ...
                <Card className="todo-form" onSubmit={this.handleSubmit}>
                    <CardContent>
                        ...
                        <TextField id="text" type="text" onChange={this.handlePartyNameChange} value={this.state.partyName} autoFocus/>
                        <br/>
                        <br/>
                        <label htmlFor="text" className="right-margin">
                            Descripción:
                        </label>
                        <TextField id="text" type="text" onChange={this.handleDescriptionChange} value={this.state.description}/>
                        <br/>
                        <br/>
                        <TextField id="date" label="Día de la fiesta:" type="date" onChange={this.handleEventDateChange} value={this.state.eventDate} InputLabelProps={{shrink: true}}
                        />
                        <br>
                        </br>                    
                        <TextField id="hour" label="Hora de la fiesta:" type="time"  defaultValue="09:30" InputLabelProps={{shrink: true,}} inputProps={{step: 300, // 5 min
                        }} onChange={this.handleEventHourChange} value={this.state.eventHour}/>
                        <br/>
                        <br/>
                        ...
                        <TextField id="place" type="text" onChange={this.handlePlaceChange} value={this.state.place}/>
                        <br/>
                        <br/>
                        ...
                        <TextField id="price" type="number" onChange={this.handlePriceChange} value={this.state.price}/>
                        <br/>
                        <br/>
                        <label htmlFor="text" className="right-margin">
                            Info (opcional):
                        </label>
                        <TextField id="text" type="text" onChange={this.handleOptionalDescriptionChange} value={this.state.optionalDescription}/>
                        <br/>
                        <br/>
                        <label htmlFor="typeOfMusic" className="right-margin">
                            Género:
                        </label>
                        <TextField id="typeOfMusic" type="text" onChange={this.handleTypeOfMusicChange} value={this.state.typeOfMusic}/>
                        <br/>
                        <br/>
                    </CardContent> 
                    <br/>
    ...
    handleSubmit(e) {
        ...
        if (!this.state.partyName.length || !this.state.eventDate.length || !this.state.address.length||!this.state.place.length||!this.state.typeOfMusic.length)
            return;
    ...
    addParty(party){
        ...
        */
        apimock.addNewParty(party.partyName,party.description,party.eventDate,party.eventHour, party.address, party.place, party.price, party.optionalDescription,party.typeOfMusic, party.assistants);
        this.getPartyList();
    }
